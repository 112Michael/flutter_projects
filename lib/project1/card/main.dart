...
import 'package:flutter_projects/project1/card/credit_card.dart';
import 'package:flutter_projects/project1/formatters/index.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Image(
          image: AssetImage('asset/image/bank_logo.png'),
          height: 30,
        ),
      ),
